...
const service = new SequelizeService(Section);
module.exports = {
    /**
     * @description Create and Save sections
     * @param {*} req 
     * @param {*} res 
     */
    ...
    /**
     * @description Retrieve all the rows of the sections
     * @param {*} req 
     * @param {*} res 
     */
    ...
    findOne: async (req, res) => {
        try {
            const { id } = req.params;
            const section = await service.findOne({ where: { id } });
